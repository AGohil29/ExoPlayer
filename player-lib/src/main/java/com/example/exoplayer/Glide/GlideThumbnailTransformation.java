package com.example.exoplayer.Glide;
...
public class GlideThumbnailTransformation extends BitmapTransformation {
    ...
    // this variable should be dynamic for different videos
    // use getDuration for duration of video and divide it by
    // the no of images in one sprite image
    ExoPlayerManager durationVideo = new ExoPlayerManager();
    public long durationMillis = durationVideo.getRealDurationMillis() / 42; // millisseconds
    public int THUMBNAILS_EACH = (int)durationMillis;
